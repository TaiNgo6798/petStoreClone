...
export class MyaccountComponent implements OnInit {
  ...
  handleOk(value): void {
    ...
    axios({
      method: 'PUT',
      url: `https://petselling.herokuapp.com/api/petshop/accounts/${this.detailCurrentUser._id}?token=${token}`,
      data: {
        name,
        image,
        phone,
    ...
    axios({
      ...
      .then((response: any) => {
        if (response.data.success === false) {
          ...
          axios({
            method: 'GET',
            url: `https://petselling.herokuapp.com/api/petshop/current?token=${token}`

          })
            .then((response: any) => {
              axios({
                method: 'GET',
                url: `https://petselling.herokuapp.com/api/petshop/accounts/${response.data.id}?token=${token}`
